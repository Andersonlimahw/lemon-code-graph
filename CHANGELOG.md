...
a [GitHub Release](https://github.com/andersonlimahw/lemon-code-graph/releases) tagged
...
[0.9.5]: https://github.com/andersonlimahw/lemon-code-graph/releases/tag/v0.9.5
...
- **Orphaned `codegraph serve --mcp` processes after a parent SIGKILL.** When
  ...
  [#277](https://github.com/andersonlimahw/lemon-code-graph/issues/277).
...
- **`codegraph: no prebuilt bundle for <platform>` after installing through a
  ...
  [#303](https://github.com/andersonlimahw/lemon-code-graph/issues/303).
- **`install.sh` failing with `403` / "could not resolve latest version" on
  ...
  `v0.9.4`. Resolves
  [#325](https://github.com/andersonlimahw/lemon-code-graph/issues/325).
...
- **`codegraph uninstall` command.** Cleanly removes CodeGraph from every agent
  ...
  [#313](https://github.com/andersonlimahw/lemon-code-graph/issues/313) — previously the
...
- **`Fatal process out of memory: Zone` crash while indexing large projects.**
  ...
  [#298](https://github.com/andersonlimahw/lemon-code-graph/issues/298) and
  [#293](https://github.com/andersonlimahw/lemon-code-graph/issues/293). (Node 25 stays
...
- **Framework support: Drupal 8/9/10/11** — CodeGraph now detects Drupal
  ...
  excluded by default. Resolves [#268](https://github.com/andersonlimahw/lemon-code-graph/issues/268).
...
- **Zero-config indexing that respects `.gitignore`.** CodeGraph no longer has a
  ...
  [#283](https://github.com/andersonlimahw/lemon-code-graph/issues/283).
...
- **Windows: `npm i -g @andersonlimahw/lemon-codegraph` then any `codegraph` command
  ...
  [#289](https://github.com/andersonlimahw/lemon-code-graph/issues/289).
...
- **MCP session marker no longer follows symlinks** (CWE-59). Every
  ...
  followed. Resolves [#280](https://github.com/andersonlimahw/lemon-code-graph/issues/280).
...
[0.9.5]: https://github.com/andersonlimahw/lemon-code-graph/releases/tag/v0.9.5
[0.9.4]: https://github.com/andersonlimahw/lemon-code-graph/releases/tag/v0.9.4
[0.9.3]: https://github.com/andersonlimahw/lemon-code-graph/releases/tag/v0.9.3
[0.9.2]: https://github.com/andersonlimahw/lemon-code-graph/releases/tag/v0.9.2
[0.9.1]: https://github.com/andersonlimahw/lemon-code-graph/releases/tag/v0.9.1
...
([#238](https://github.com/andersonlimahw/lemon-code-graph/issues/238)). That entire class of
...
- **Luau** ([#232](https://github.com/andersonlimahw/lemon-code-graph/issues/232)):
...
- **SQLite backend is now Node's built-in `node:sqlite`** (real SQLite, WAL +
  ...
  `database is locked` errors ([#238](https://github.com/andersonlimahw/lemon-code-graph/issues/238))
...
[0.9.0]: https://github.com/andersonlimahw/lemon-code-graph/releases/tag/v0.9.0
...
- **Framework routes (NestJS)**: CodeGraph now recognises NestJS projects and
  ...
  Resolves [#220](https://github.com/andersonlimahw/lemon-code-graph/issues/220).
...
- **Minimum Node.js is now 20** (was 18). Node 18 is end-of-life and the
  ...
  [#81](https://github.com/andersonlimahw/lemon-code-graph/issues/81)).
- **MCP / explore**: `codegraph_explore` output is now adaptive to project
  ...
  [#185](https://github.com/andersonlimahw/lemon-code-graph/issues/185). The budget
...
- **Sync / status**: git-untracked files are no longer reported as pending
  ...
  Closes [#206](https://github.com/andersonlimahw/lemon-code-graph/issues/206). Thanks to
...
- **Indexing**: `codegraph init -i` now finds source inside nested, independent
  ...
  `.gitignore`. Closes
  [#193](https://github.com/andersonlimahw/lemon-code-graph/issues/193). Thanks to
...
- **Native SQLite backend on Node 24**: indexing on Node 24 always dropped to
  ...
  not clear ([#203](https://github.com/andersonlimahw/lemon-code-graph/issues/203)).
...
- **MCP**: tools no longer fail with "CodeGraph not initialized" when the index
  ...
  [#196](https://github.com/andersonlimahw/lemon-code-graph/issues/196). Thanks to
...
- **MCP**: the server no longer hangs on startup under WSL2 when the project
  ...
  [#172](https://github.com/andersonlimahw/lemon-code-graph/issues/172) startup fix:
  ...
  Closes [#199](https://github.com/andersonlimahw/lemon-code-graph/issues/199).
...
- **Installer (Claude Code)**: project-local installs (`Just this project`)
  ...
  [#207](https://github.com/andersonlimahw/lemon-code-graph/issues/207). Thanks to
...
- **MCP**: tools no longer silently fail to appear in clients on slow
  ...
  [#172](https://github.com/andersonlimahw/lemon-code-graph/issues/172). Thanks to
...
- **CLI**: terminal output no longer mojibakes on Windows PowerShell /
  ...
  [#168](https://github.com/andersonlimahw/lemon-code-graph/issues/168). Thanks to
...
- **MCP / search**: module-qualified symbol lookups now resolve. The
  ...
  [#173](https://github.com/andersonlimahw/lemon-code-graph/issues/173). Thanks
...
[0.8.0]: https://github.com/andersonlimahw/lemon-code-graph/releases/tag/v0.8.0
[0.7.10]: https://github.com/andersonlimahw/lemon-code-graph/releases/tag/v0.7.10
...
[0.7.8]: https://github.com/andersonlimahw/lemon-code-graph/releases/tag/v0.7.8

## [0.7.7] - 2026-05-17

### Added
- **Multi-agent installer** (closes [#137](https://github.com/andersonlimahw/lemon-code-graph/issues/137)).
...
[0.7.7]: https://github.com/andersonlimahw/lemon-code-graph/releases/tag/v0.7.7
...
[0.7.6]: https://github.com/andersonlimahw/lemon-code-graph/releases/tag/v0.7.6
